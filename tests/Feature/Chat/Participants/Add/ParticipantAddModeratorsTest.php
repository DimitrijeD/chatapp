...
class ParticipantAddModeratorsTest extends TestCase
{
    ...
    public function test_participant_cannot_add_1_creator_to_any_group()
    {
    ...
    public function test_participant_cannot_add_many_creators_to_any_group()
    {
        foreach(ChatGroup::TYPES as $type)
        {
            $groupCondig = array_merge(['model_type' => $type], $this->getParticipantGroupConfig());
