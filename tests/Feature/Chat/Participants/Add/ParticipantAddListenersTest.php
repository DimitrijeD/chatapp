...
class ParticipantAddListenersTest extends TestCase
{
    ...
    public function test_participant_cannot_add_1_listener_to_any_group()
    {
    ...
    public function test_participant_cannot_add_listeners_to_any_group()
    {
        foreach(ChatGroup::TYPES as $type)
        {
            $groupCondig = array_merge(['model_type' => $type], $this->getParticipantGroupConfig());
