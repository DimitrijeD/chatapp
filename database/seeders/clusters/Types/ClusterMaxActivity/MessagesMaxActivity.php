...
class MessagesMaxActivity extends MessageProvider implements Cluster
{

    /**
     * For 'u' users and 'nm' number of messages, create random number of messages 'enm' for each user, while iterating over same array of users.
     ...
     * 
     * Note that default seeder also uses random number of messages per cluster, difference is, this one has higher cluster size range,
     * attempting to simulate higher deviation in user's message sending/typing style. 
     */
