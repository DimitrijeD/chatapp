...
class MessagesEven extends MessageProvider implements Cluster
{
    /**
     * For 'u' users and 'nm' number of messages, create equal number of messages 'enm' for each user, while iterating over same array of users.
    ...
    private function setDefaultClusterSize()
    {
        $this->clusterSize = 1;
    }
}